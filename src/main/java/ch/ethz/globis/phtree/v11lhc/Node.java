...
import ch.ethz.globis.phtree.v11lhc.nt.NodeTreeV11;
import ch.ethz.globis.phtree.v11lhc.nt.NtIteratorMask;
import ch.ethz.globis.phtree.v11lhc.nt.NtIteratorMinMax;
import ch.ethz.globis.phtree.v11lhc.nt.NtNode;
import ch.ethz.globis.phtree.v11lhc.nt.NtNodePool;
...
public class Node {
	 ...
	 */
	Object doInsertIfMatching(long[] keyToMatch, Object newValueToInsert, PhTreeLhc11<?> tree) {
...
//		int offs = pinToOffsBitsData(pin, hcPos, keyToMatch.length);
	...
	Object doIfMatching(long[] keyToMatch, boolean getOnly, Node parent,
			long[] newKey, int[] insertRequired, PhTreeLhc11<?> tree) {
	...
	private Object insertSplit(long[] newKey, Object newValue, Object currentValue,
			int pin, long hcPos, PhTreeLhc11<?> tree, int offs, long mask) {
        //do the splitting
