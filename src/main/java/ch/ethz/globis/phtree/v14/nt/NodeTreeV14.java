 ...
 */
public class NodeTreeV14<T> implements MaxKTreeI {
	...
	private NodeTreeV14(int keyBitWidth) {
     ...
     * @param <T> value type
	 */
	public static <T> NodeTreeV14<T> create(int keyBitWidth) {
		return new NodeTreeV14<>(keyBitWidth);
	}
	...
	public boolean contains(long key, long[] outKdKey) {
		return NodeTreeV14.getEntry(root, key, outKdKey, null, null) != null;
	}
	
	@SuppressWarnings("unchecked")
	public T get(long key, long[] outKdKey) {
		Object ret = NodeTreeV14.getEntry(root, key, outKdKey, null, null);
		return ret == NT_NULL ? null : (T)ret;
	}
	
	@SuppressWarnings("unchecked")
	public T remove(long key) {
		Object ret = NodeTreeV14.removeEntry(root, key, getKeyBitWidth(), nEntries);
		return ret == NT_NULL ? null : (T)ret;
	}
