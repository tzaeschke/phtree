...
public class Node {
	...
	private void initNode(int infixLenClassic, int postLenClassic, int dims, PhTree16HD<?> tree) {
	...
	public static Node createNode(int dims, int infixLenClassic, int postLenClassic, PhTree16HD<?> tree) {
		Node n = tree.nodePool().get();
		n.initNode(infixLenClassic, postLenClassic, dims, tree);
		return n;
	}

	private void discardNode(PhTree16HD<?> tree) {
		entryCnt = 0;
		getRoot().clear();
	...
	Object doInsertIfMatching(long[] keyToMatch, Object newValueToInsert, PhTree16HD<?> tree, long[] hcBuf) {
		...
		Object v = addEntry(hcBuf, keyToMatch, newValueToInsert, tree);
	...
	Object doIfMatching(long[] keyToMatch, boolean getOnly, Node parent, UpdateInfo insertRequired, 
		...
		Object v = removeEntry(hcBuf, keyToMatch, insertRequired, tree);
	...
	private void mergeIntoParentNt(long[] key, Node parent, PhTree16HD<?> tree) {
	 ...
	 */
	private void writeEntry(int pin, long[] hcPos, long[] newKey, Object value, PhTree16HD<?> tree) {
	...
	private BSTreePage bstCreateRoot(PhTree16HD<?> tree) {
	...
	public final BSTEntry bstGetOrCreate(long[] key, PhTree16HD<?> tree) {
	...
	public BSTEntry bstRemove(long[] key, long[] kdKey, PhTree16HD.UpdateInfo ui, PhTree16HD<?> tree) {
	...
	public BSTreePage bstCreatePage(BSTreePage parent, boolean isLeaf, BSTreePage leftPredecessor, PhTree16HD<?> tree) {
	 ...
	 * @return see above
	 */
	Object addEntry(long[] hcPos, long[] kdKey, Object value, PhTree16HD<?> tree) {
		//Uses bstGetOrCreate() -> 
		//- get or create entry			return;
	...
	private Object handleCollision(BSTEntry existingE, long[] kdKey, Object value, PhTree16HD<?> tree) {
	...
	private Object insertSplit(BSTEntry currentEntry, long[] newKey, Object newValue, long mask, PhTree16HD<?> tree) {
		if (mask == 0) {
	 ...
	 * @return See contract.
	 */
	private Object removeEntry(long[] hcPos, long[] key, UpdateInfo ui, PhTree16HD<?> tree) {
