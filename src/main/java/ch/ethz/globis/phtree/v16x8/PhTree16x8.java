 ...
 *
 */
public class PhTree16x8<T> implements PhTree<T> {
	...
	public PhTree16x8(PhTreeConfig cnf) {
    ...
    void insertRoot(long[] key, Object value) {
        ...
        byte pos = Node.toByte(posInArray(key, root.getPostLen()));
