...
import ch.ethz.globis.phtree.util.MinHeapI.MinHeapPoolI;
...
public class MinHeapPoolTest {
    ...
    private void populate(MinHeapPoolI<Entry> heap, DataEntry[] data) {
    ...
    public void testMin() {
        long time = 0;
        Entry.N = 0;
        MinHeapPoolI<Entry> heap = create();
    ...
    private long testMin(MinHeapPoolI<Entry> heap, int n, int seed) {
