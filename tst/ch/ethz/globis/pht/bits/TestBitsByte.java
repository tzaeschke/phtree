...
import ch.ethz.globis.pht.util.BitsByte;
...
public class TestBitsByte {
	...
	public void testCopy1() {
		...
		//byte[] s = newBA(0b1111_1111, 0b1111_1111);  //TODO java 7
		byte[] t = new byte[2];
	...
	public void testCopyRShift1_OneByteToTwoByte() {
		System.err.println("WARNING: Test disabled: TestBitsByte.testCopyRShift1_OneByteToTwoByte()");
//		byte[] s = newBA(0xAA, 0x0A);
//		BitsByte.copyBitsRight(s, 4, s, 6, 4);
//		check(s, 0xAA, 0x8A);
	}
	
	@Test
	public void testCopyRShift1_TwoByteToOneByte() {
		System.err.println("WARNING: Test disabled: TestBitsByte.testCopyRShift1_TwoByteToOneByte()");
//		byte[] s = newBA(0xAA, 0xF5);
//		BitsByte.copyBitsRight(s, 6, s, 8, 4);
//		check(s, 0xAA, 0xB5);
	}
	...
	public void testCopyRightRandom() {
		System.err.println("WARNING: Test disabled: TestBitsByte.testCopyRightRandom()");
//		Random rnd = new Random();
//		int BA_LEN = 6;
//		byte[] ba = new byte[BA_LEN];
//		for (int i1 = 0; i1 < 1000000; i1++) {
...
//			
//			int start = rnd.nextInt(8) + 8;  //start somewhere in fourth byte
//			int nBits = rnd.nextInt(8 * 3); //remove up to three bytes 
//			//compute
//			//System.out.println("i=" + i1 + " start=" + start + " nBits=" + nBits);
//			BitsByte.copyBitsRight(ba1, start, ba1, start+nBits, ba1.length*8-start-nBits);
//			//compute backup
